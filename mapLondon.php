...
switch(x){ 
case 0: mymap.flyTo(boroughs.BarkingDagenham.split(","), 15); break;
case 1: mymap.flyTo(boroughs.Barnet.split(","), 15); break;
case 2: mymap.flyTo(boroughs.Bexley.split(","), 15); break;
case 3: mymap.flyTo(boroughs.Brent.split(","), 15); break;
case 4: mymap.flyTo(boroughs.Bromley.split(","), 15); break;
case 5: mymap.flyTo(boroughs.Camden.split(","), 15); break;
case 6: mymap.flyTo(boroughs.Croydon.split(","), 15); break;
case 7: mymap.flyTo(boroughs.Ealing.split(","), 15); break;
case 8: mymap.flyTo(boroughs.Enfield.split(","), 15); break;
case 9: mymap.flyTo(boroughs.Greenwich.split(","), 15); break;
case 10: mymap.flyTo(boroughs.Hackney.split(","), 15); break;
case 11: mymap.flyTo(boroughs.HammersmithFulham.split(","), 15); break;
case 12: mymap.flyTo(boroughs.Haringey.split(","), 15); break;
case 13: mymap.flyTo(boroughs.Harrow.split(","), 15); break;
case 14: mymap.flyTo(boroughs.Havering.split(","), 15); break;
case 15: mymap.flyTo(boroughs.Hillingdon.split(","), 15); break;
case 16: mymap.flyTo(boroughs.Hounslow.split(","), 15); break;
case 17: mymap.flyTo(boroughs.Islington.split(","), 15); break;
case 18: mymap.flyTo(boroughs.KensingtonChelsea.split(","), 15); break;
case 19: mymap.flyTo(boroughs.KingstonThames.split(","), 15); break;
case 20: mymap.flyTo(boroughs.Lambeth.split(","), 15); break;
case 21: mymap.flyTo(boroughs.Lewisham.split(","), 15); break;
case 22: mymap.flyTo(boroughs.Merton.split(","), 15); break;
case 23: mymap.flyTo(boroughs.Newham.split(","), 15); break;
case 24: mymap.flyTo(boroughs.Redbridge.split(","), 15); break;
case 25: mymap.flyTo(boroughs.RichmondThames.split(","), 15); break;
case 26: mymap.flyTo(boroughs.Southwark.split(","), 15); break;
case 27: mymap.flyTo(boroughs.Sutton.split(","), 15); break;
case 28: mymap.flyTo(boroughs.TowerHamlets.split(","), 15); break;
case 29: mymap.flyTo(boroughs.WalthamForest.split(","), 15); break;
case 30: mymap.flyTo(boroughs.Wandsworth.split(","), 15); break;
case 31: mymap.flyTo(boroughs.Westminster.split(","), 15); break;
case 32: mymap.flyTo(boroughs.CityLondon.split(","), 15); break;
default:
return
}}
